            ...
            <div class="card card-dashboard text-white" style="background: linear-gradient(135deg, #28a745, #20c997);">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title mb-0"><?php echo e($data['totalCalculations'] ?? 156); ?></h4>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card card-dashboard text-white" style="background: linear-gradient(135deg, #17a2b8, #6f42c1);">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title mb-0"><?php echo e($data['plantTypes'] ?? 23); ?></h4>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card card-dashboard text-white" style="background: linear-gradient(135deg, #ffc107, #fd7e14);">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title mb-0"><?php echo e(number_format($data['plantsCalculated'] ?? 12450)); ?></h4>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card card-dashboard text-white" style="background: linear-gradient(135deg, #dc3545, #e83e8c);">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title mb-0"><?php echo e($data['totalAreaPlanned'] ?? '8.5 ha'); ?></h4>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="d-grid">
                                <a href="<?php echo e(route('planting.calculator')); ?>" class="btn btn-plant btn-lg">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="d-grid">
                                <a href="<?php echo e(route('quincunx.calculator')); ?>" class="btn btn-success btn-lg">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="d-grid">
                                <a href="<?php echo e(route('triangular.calculator')); ?>" class="btn btn-info btn-lg">
            ...
            <div class="card card-dashboard">
                ...
                <div class="card-body">
                    <div class="activity-list">
                        <?php $__empty_1 = true; $__currentLoopData = $data['recentCalculations'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $calculation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="activity-item d-flex align-items-start mb-3">
                            ...
                            <div class="activity-content">
                                <p class="mb-1">
                                    <?php if($calculation->plant_type): ?>
                                        <?php echo e($calculation->plant_type); ?> calculation
                                    <?php else: ?>
                                        New calculation
                                    <?php endif; ?>
                                    (<?php echo e(number_format($calculation->total_plants)); ?> plants)
                                </p>
                                <small class="text-muted"><?php echo e($calculation->created_at->diffForHumans()); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="text-center py-4">
                            ...
                            <a href="<?php echo e(route('planting.calculator')); ?>" class="btn btn-plant btn-sm">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $data['popularPlants'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $plant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            <i class="fas fa-seedling text-<?php echo e($color); ?> me-2"></i>
                                            <?php echo e($plant->plant_type ?? 'Unknown Plant'); ?>

                                        </td>
                                        <td class="text-end">
                                            <span class="badge bg-<?php echo e($color); ?>"><?php echo e($plant->calculations_count); ?> calculations</span>
                                            <br><small class="text-muted"><?php echo e(number_format($plant->total_plants)); ?> plants</small>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\G4_APP-DEV\project\resources\views/dashboard.blade.php ENDPATH**/ ?>