    ...
    <div class="sidebar-content">
        ...
        <nav class="mt-3">
            <ul class="sidebar-menu">
                ...
                <li class="<?php echo e(request()->routeIs('planting.calculator') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('planting.calculator')); ?>">
...
<?php /**PATH C:\xampp\htdocs\G4_APP-DEV\project\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>