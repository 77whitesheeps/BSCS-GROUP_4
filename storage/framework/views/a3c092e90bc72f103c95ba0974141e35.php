            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition duration-200">
                            ← Back to Dashboard
                        </a>
                    </div>
                </div>
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('calculate.quincunx')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="space-y-4">
                            <!-- Area Dimensions -->
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-2">
                                        <input type="number" id="areaLength" name="areaLength" step="0.01" min="0.01" 
                                               ...
                                               value="<?php echo e(old('areaLength', $inputs['areaLength'] ?? '')); ?>" 
                                               placeholder="10" required>
                                        <select name="lengthUnit" class="mt-1 rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                                            <option value="m" <?php echo e((old('lengthUnit', $inputs['lengthUnit'] ?? '') == 'm') ? 'selected' : ''); ?>>m</option>
                                            <option value="ft" <?php echo e((old('lengthUnit', $inputs['lengthUnit'] ?? '') == 'ft') ? 'selected' : ''); ?>>ft</option>
                                            <option value="cm" <?php echo e((old('lengthUnit', $inputs['lengthUnit'] ?? '') == 'cm') ? 'selected' : ''); ?>>cm</option>
                                            <option value="in" <?php echo e((old('lengthUnit', $inputs['lengthUnit'] ?? '') == 'in') ? 'selected' : ''); ?>>in</option>
                                        </select>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="flex gap-2">
                                        <input type="number" id="areaWidth" name="areaWidth" step="0.01" min="0.01" 
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500" 
                                               value="<?php echo e(old('areaWidth', $inputs['areaWidth'] ?? '')); ?>" 
                                        ...
                                        <select name="widthUnit" class="mt-1 rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                                            <option value="m" <?php echo e((old('widthUnit', $inputs['widthUnit'] ?? '') == 'm') ? 'selected' : ''); ?>>m</option>
                                            <option value="ft" <?php echo e((old('widthUnit', $inputs['widthUnit'] ?? '') == 'ft') ? 'selected' : ''); ?>>ft</option>
                                            <option value="cm" <?php echo e((old('widthUnit', $inputs['widthUnit'] ?? '') == 'cm') ? 'selected' : ''); ?>>cm</option>
                                            <option value="in" <?php echo e((old('widthUnit', $inputs['widthUnit'] ?? '') == 'in') ? 'selected' : ''); ?>>in</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex gap-2">
                                    <input type="number" id="plantSpacing" name="plantSpacing" step="0.01" min="0.01" 
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500" 
                                           value="<?php echo e(old('plantSpacing', $inputs['plantSpacing'] ?? '')); ?>" 
                                    ...
                                    <select name="spacingUnit" class="mt-1 rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                                        <option value="m" <?php echo e((old('spacingUnit', $inputs['spacingUnit'] ?? '') == 'm') ? 'selected' : ''); ?>>m</option>
                                        <option value="ft" <?php echo e((old('spacingUnit', $inputs['spacingUnit'] ?? '') == 'ft') ? 'selected' : ''); ?>>ft</option>
                                        <option value="cm" <?php echo e((old('spacingUnit', $inputs['spacingUnit'] ?? '') == 'cm') ? 'selected' : ''); ?>>cm</option>
                                        <option value="in" <?php echo e((old('spacingUnit', $inputs['spacingUnit'] ?? '') == 'in') ? 'selected' : ''); ?>>in</option>
                                    </select>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="flex gap-2">
                                    <input type="number" id="borderSpacing" name="borderSpacing" step="0.01" min="0" 
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500" 
                                           value="<?php echo e(old('borderSpacing', $inputs['borderSpacing'] ?? 0)); ?>" 
                                           placeholder="0">
                                    <select name="borderUnit" class="mt-1 rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                                        <option value="m" <?php echo e((old('borderUnit', $inputs['borderUnit'] ?? '') == 'm') ? 'selected' : ''); ?>>m</option>
                                        <option value="ft" <?php echo e((old('borderUnit', $inputs['borderUnit'] ?? '') == 'ft') ? 'selected' : ''); ?>>ft</option>
                                        <option value="cm" <?php echo e((old('borderUnit', $inputs['borderUnit'] ?? '') == 'cm') ? 'selected' : ''); ?>>cm</option>
                                        <option value="in" <?php echo e((old('borderUnit', $inputs['borderUnit'] ?? '') == 'in') ? 'selected' : ''); ?>>in</option>
                                    </select>
                                </div>
                        ...
                        <div class="space-y-4 fade-in">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="bg-green-50 p-4 rounded-lg">
                                    ...
                                    <p class="text-2xl font-bold text-green-600"><?php echo e(number_format($results['totalPlants'])); ?></p>
                                </div>
                                <div class="bg-blue-50 p-4 rounded-lg">
                                    <h3 class="font-semibold text-blue-800">Number of Rows</h3>
                                    <p class="text-2xl font-bold text-blue-600"><?php echo e(number_format($results['numberOfRows'])); ?></p>
                                </div>
                                <div class="bg-purple-50 p-4 rounded-lg">
                                    <h3 class="font-semibold text-purple-800">Avg Plants/Row</h3>
                                    <p class="text-2xl font-bold text-purple-600"><?php echo e($results['averagePlantsPerRow'] ?? 'N/A'); ?></p>
                                </div>
                                <div class="bg-yellow-50 p-4 rounded-lg">
                                    <h3 class="font-semibold text-yellow-800">Efficiency</h3>
                                    <p class="text-2xl font-bold text-yellow-600"><?php echo e($results['efficiency'] ?? 'N/A'); ?>%</p>
                                </div>
                            </div>
                            <div class="text-sm text-gray-600 space-y-1">
                                <p>Pattern Type: <span class="font-medium"><?php echo e($results['patternType'] ?? 'Quincunx (Staggered)'); ?></span></p>
                                <p>Effective Area: <span class="font-medium"><?php echo e(number_format($results['effectiveArea'], 2)); ?></span> m²</p>
                                <p>Planting Density: <span class="font-medium"><?php echo e(number_format($results['plantingDensity'], 2)); ?></span> plants/m²</p>
                                <?php if(isset($results['rowSpacing'])): ?>
                                    <p>Row Spacing: <span class="font-medium"><?php echo e($results['rowSpacing']); ?></span> m</p>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php else: ?>
            ...
            <div class="mt-8 bg-white rounded-lg shadow-md p-6 fade-in">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        ...
                        <?php if(isset($results['rowDetails'])): ?>
                            <div class="bg-blue-50 p-4 rounded-lg">
                                <h4 class="font-semibold mb-2 text-blue-800">Row Breakdown:</h4>
                                <div class="text-sm space-y-1 max-h-32 overflow-y-auto">
                                    <?php $__currentLoopData = $results['rowDetails']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="<?php echo e($row['offset'] ? 'text-blue-600' : 'text-green-600'); ?>">
                                            Row <?php echo e($row['row']); ?>: <?php echo e($row['plants']); ?> plants <?php echo e($row['offset'] ? '(offset)' : ''); ?>
                            ...
                            <div class="absolute inset-0 p-4">
                                <svg class="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
                                    <?php if(isset($results['rowDetails'])): ?>
                                        ...
                                        ?>
                                        <?php $__currentLoopData = array_slice($results['rowDetails'], 0, $maxRows); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowIndex => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                $y = 15 + ($rowIndex * 70 / $maxRows);
                                                $plantsToShow = min($row['plants'], $maxCols);
                                            ?>
                                            <?php for($plantIndex = 0; $plantIndex < $plantsToShow; $plantIndex++): ?>
                                                <?php
                                                    $baseX = 10 + ($plantIndex * 80 / $maxCols);
                                                    $x = $row['offset'] ? $baseX + (40 / $maxCols) : $baseX;
                                                    $color = $row['offset'] ? '#3b82f6' : '#10b981';
                                                ?>
                                                <circle cx="<?php echo e($x); ?>" cy="<?php echo e($y); ?>" r="2" fill="<?php echo e($color); ?>" class="plant-dot" />
                                            <?php endfor; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
...
</html>hp<?php /**PATH C:\xampp\htdocs\G4_APP-DEV\project\resources\views/quincunx-calculator.blade.php ENDPATH**/ ?>